...
- `terminalShell`: ignored leftover. Older files may still contain `auto`, `pwsh`, `windowsPowerShell`, or `cmd`. Readers accept the field and writers omit it. The Windows Terminal profile owns the shell.
