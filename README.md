...
在文件夹空白处或选中一个文件夹后点击右键，即可用喜欢的 AI 编程助手打开当前目录。RightAgent 既支持分组菜单“使用 RightAgent 打开”，也支持“使用 Claude Code 打开”这样的直达命令。菜单模式、启用状态、排列顺序、命令、网址、图标、界面语言、命令解释器和 Windows Terminal 配置文件，都可以在 WinUI 3 设置应用中统一管理。
